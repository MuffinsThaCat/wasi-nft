...
const Hash = tslib_1.__importStar(require("typestub-ipfs-only-hash"));
...
class LitNodeClientNodeJs extends core_1.LitCore {
    ...
    `);
        ...
        this.getIpfsId = async ({ str }) => {
            return (await Hash.of(Buffer.from(str)));
        };
        /**
